...
public class QuizQuestions {
	...
	public static void main(String[] args) {
		...
		double[] doubles2 = { 46.7, 31.2, 68.3 };
		System.out.println(dblAvgs(doubles2));
		...
		System.out.println("\nQuestion 19 dup:");
		int[] nameLengths2 = stringLengths(names);
		for (int number : nameLengths2) {
			System.out.println(number);
		}
		...
		System.out.println(isaPalindrome("radar"));
		System.out.println(isaPalindrome("palindrome"));
	...
	{
		int i = 0;
		int[] strLts = new int[names.length];
	...
	public static Double dblAvgs(double[] arr)
	{
		double total=0.0;
		for (Double ele: arr){
				total += ele;
